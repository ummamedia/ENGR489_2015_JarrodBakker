...
#       traffic orginating from h1 gets blocked at s1. h1 should only
#       be able to contact h2. As TCP and UDP packets do not receive
#       replies were on top of IPv6 and sent using Scapy, ICMPv6
#       Echo Requests will be used to test the lack of connectivity.
#       Care must be taken that this test is run on host 1 with an
#       IPv6 address of fe80::200:ff:fe00:1. The ACL rules can be
#       found in PoliciesDropAllH1_IPv6Ping_rules.json
#
# Usage: python PoliciesDropAllH1_IPv6Ping.py <number of hosts in the network>
#
...
#
# Note:
#   - Test output can be found in PoliciesDropAllH1_IPv6Ping_results.log
#
