...
#
# Test: Using a Mininet tree topology (depth=2), verify that traffic
#       orginating from h3 will get blocked at s1. h3 should only
#       be able to contact h4. Care must be taken that this test is
#       run on host 3 with an IPv4 address of 10.0.0.3. The ACL rules
#       can be found in PoliciesDropAllH3_IPv4All_rules.json
#
# Usage: python PoliciesDropAllH3_IPv4All.py <number of hosts in the network>
#
...
#
# Note:
#   - Test output can be found in PoliciesDropAllH1_IPv4All_results.log
#
