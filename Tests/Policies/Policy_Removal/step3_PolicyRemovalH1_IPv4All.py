...
#       step3_PolicyRemovalH1_IPv4All_rules.json
#
# Usage: python step3_PolicyRemovalH1_IPv4All.py <number of hosts in the network>
#
...
#
# Note:
#   - Test output can be found in step3_PolicyRemovalH1_IPv4All_results.log
#
