...
#       orginating from h1 will get blocked at s1. h1 should only
#       be able to contact h2. Care must be taken that this test is
#       run on host 1 with an IPv4 address of 10.0.0.1. The ACL rules
#       can be found in step5_PolicyRemovalH1_IPv4All_rules.json
#
# Usage: python step5_PolicyRemovalH1_IPv4All.py <number of hosts in the network>
#
...
#
# Note:
#   - Test output can be found in step5_PolicyRemovalH1_IPv4All_results.log
#
