...
#       rules can be found in step3_RuleRemovalH1_IPv4TCP_rules.json
#
# Usage: python step3_RuleRemovalH1_IPv4TCP.py <number of hosts in the network>
#
...
#
# Note:
#   - Test output can be found in step3_RuleRemovalH1_IPv4TCP_results.log
#
