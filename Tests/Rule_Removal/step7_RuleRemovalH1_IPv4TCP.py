...
#
# Test: Verify that select packets with a TCP header don't get blocked
#       when they originate from host 1. Care must be taken that this
#       test is run on host 1 with an IPv4 address of 10.0.0.1. The
#       rules can be found in step7_RuleRemovalH1_IPv4TCP_rules.json
#
# Usage: python step7_RuleRemovalH1_IPv4TCP.py <number of hosts in the network>
#
...
#
# Note:
#   - Test output can be found in step7_RuleRemovalH1_IPv4TCP_results.log
#
