...
#       TimeDispatch_TwoHost_DropH1_rules.json
#
# Usage: python TimeDispatch_TwoHost_DropH1 <number of hosts in the network>
#
...
#
# Note:
#   - Test output can be found in TimeDispatch_TwoHost_DropH1_results.log
#
...
def test(num_hosts):
    ...
    # Check that h1 can still contact h2
    logging.info("\th1 should be able to contact h2")
    ...
    # Check that h1 can contact h2 again
    logging.info("\th1 should be able to contact h2")
    for n in neighbours_ipv4:
        logging.info("\t{0} --ICMP ping--> {1}".format(host_ip4,n)) 
        print("\t{0} --ICMP ping--> {1}".format(host_ip4,n)) 
