...
#       found in NoDrop_IPv6Ping_rules.json
#
# Usage: python NoDrop_IPv6Ping.py <number of hosts in the network>
#
...
#
# Note:
#   - Test output can be found in NoDrop_IPv6Ping_results.log
#
