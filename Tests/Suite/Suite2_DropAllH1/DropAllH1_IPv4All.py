...
#       can be found in DropAllH1_IPv4All_rules.json
#
# Usage: python DropAllH1_IPv4All.py <number of hosts in the network>
#
...
#
# Note:
#   - Test output can be found in DropAllH1_IPv4All_results.log
#
