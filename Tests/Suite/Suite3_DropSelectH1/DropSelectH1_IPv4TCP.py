...
#       can be found in DropSelectH1_IPv4TCP_rules.json
#
# Usage: python DropSelectH1_IPv4TCP.py <number of hosts in the network>
#
...
#
# Note:
#   - Test output can be found in DropSelectH1_IPv4TCP_results.log
#
