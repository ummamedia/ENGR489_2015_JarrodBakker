...
#       can be found in DropSelectH1_IPv4UDP_rules.json
#
# Usage: python DropSelectH1_IPv4UDP.py <number of hosts in the network>
#
...
#
# Note:
#   - Test output can be found in DropSelectH1_IPv4UDP_results.log
#
