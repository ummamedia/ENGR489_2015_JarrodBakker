...
#       DropAllH1Dest_IPv6Ping_rules.json
#
# Usage: python DropAllH1Dest_IPv6Ping.py <number of hosts in the network>
#
...
#
# Note:
#   - Test output can be found in DropAllH1Dest_IPv6Ping_results.log
#
