...
#       DropSelectH1Dest_IPv6TCP_srcdPort_rules.json
#
# Usage: python DropSelectH1Dest_IPv6TCP_srcPort.py <number of hosts in the network>
#
...
#
# Note:
#   - Test output can be found in DropSelectH1Dest_IPv6TCP_srcPort_results.log
#
