...
#       originates from host 1 and is destined for host 2. Traffic
#       sent from host to other hosts is allowed. Care must be take
#       that this test is run on host 1 with an IPv4 address of
#       10.0.0.1. The ACL rules can be found in
#       DropSelectTwoHost_IPv4All_rules.json
#
# Usage: python DropSelectTwoHost_IPv4All.py <number of hosts in the network>
#
...
#
# Note:
#   - Test output can be found in DropAllTwoHost_IPv4All_results.log
#
