...
#       originate from host 1 and are destined for h2. All other
#       traffic is allowed. Care must be taken that this test is
#       run on host 1 with an IPv4 address of 10.0.0.1. The rules
#       can be found in DropAllTwoHost_IPv4TCP_rules.json
#
# Usage: python DropAllTwoHost_IPv4TCP.py <number of hosts in the network>
#
...
#
# Note:
#   - Test output can be found in DropAllTwoHost_IPv4TCP_results.log
#
