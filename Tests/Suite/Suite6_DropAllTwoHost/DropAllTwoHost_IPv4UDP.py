...
#       originate from host 1 and are destined for host 2. All other
#       traffic is allowed. Care must be taken that this test is
#       run on host 1 with an IPv4 address of 10.0.0.1. The ACL rules
#       can be found in DropAllTwoHost_IPv4UDP_rules.json
#
# Usage: python DropAllTwoHost_IPv4UDP.py <number of hosts in the network>
#
