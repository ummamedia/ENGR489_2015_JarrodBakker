...
#       host 1 and is destined for host 2. All other traffic is allowed.
#       As TCP and UDP packets do not receive replies were on top of
#       IPv6 and sent using Scapy, ICMPv6 Echo Requests will be
...
#       DropAllTwoHost_IPv6Ping_rules.json
#
# Usage: python DropAllTwoHost_IPv6Ping.py <number of hosts in the network>
#
...
#
# Note:
#   - Test output can be found in DropAllTwoHost_IPv6Ping_results.log
#
