...
#       they originate from host 1 and are destined for host 2. All
...
#       can be found in DropSelectTwoHost_IPv4UDP_rules.json
#
# Usage: python DropSelectTwoHost_IPv4UDP.py <number of hosts in the network>
#
...
#
# Note:
#   - Test output can be found in DropSelectTwoHost_IPv4UDP_results.log
#
