...
#
# Test: Verify that IPv4 ping traffic can flow through the network when
#       it is destined for host 1. Care must be taken that this test is
#       run on host 1 with an IPv4 address of 10.0.0.1. The ACL rules
#       can be found in DropH1SameRuleDiffSwitch_IPv4All_rules.json
#
# Usage: python DropH1SameRuleDiffSwitch_IPv4All.py <number of hosts in the network>
#
...
#
# Note:
#   - Test output can be found in DropH1SameRuleDiffSwitch_IPv4Ping_results.log
#
