...
#       can be found in DropH1SameRuleDiffSwitch_IPv4TCP_rules.json
#
# Usage: python DropH1SameRuleDiffSwitch_IPv4TCP.py <number of hosts in the network>
#
...
#
# Note:
#   - Test output can be found in DropH1SameRuleDiffSwitch_IPv4TCP_results.log
#
