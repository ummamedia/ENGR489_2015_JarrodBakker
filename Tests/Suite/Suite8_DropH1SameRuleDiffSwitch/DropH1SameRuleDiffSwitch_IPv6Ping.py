...
#
# Test: Verify that IPv6 traffic gets blocked when it is destined for
...
#       DropH1SameRuleDiffSwitch_IPv6Ping_rules.json
#
# Usage: python DropH1SameRuleDiffSwitch_IPv6Ping.py <number of hosts in the network>
#
...
#
# Note:
#   - Test output can be found in DropH1SameRuleDiffSwitch_IPv6Ping_results.log
#
