...
#       DropH1SameRuleDiffSwitch_IPv6TCP_destPort_rules.json
#
# Usage: python DropH1SameRuleDiffSwitch_IPv6TCP_destPort.py <number of hosts in the network>
#
...
#
# Note:
#   - Test output can be found in DropH1SameRuleDiffSwitch_IPv6TCP_destPort_results.log
#
